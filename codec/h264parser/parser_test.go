...
func TestAnnexBToAVCC(t *testing.T) {
	...
	avccFrame, err := AnnexBToAVCC(annexbFrame)
	if err != nil {
		t.Error(err)
	}

	if avccFrameHex := hex.EncodeToString(avccFrame); avccFrameHex != "" {
		t.Errorf("unexpected avccFrame = %v", avccFrameHex)
	}
}
